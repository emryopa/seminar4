...
class AuroraApp:
    ...
    def __init__(self, args: argparse.Namespace):
        ...
        self.repo = DataRepository(args.imput)
...
def parse_args():
    p = argparse.ArgumentParser(description="Add a description")
    ...
    p.add_argument('--country', help="Comma separated list of coutries, e.g. CZ,DE")
    ...
    p.add_argument('--triage', help="Comma separated list of triage priority, e.g. P1,P2")
    ...
    p.add_argument('--channel-darknet', action='store_true', help="Only include events with channel_darknet")
